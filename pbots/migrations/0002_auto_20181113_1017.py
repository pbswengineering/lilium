...
def insert_default_sources(apps, schema_editor) -> None:
    ...
    Source(id=1,
           ...
           command="albopretorio_comune_acquasparta").save()
    Source(id=2,
           name="Albo Pretorio del Comune di Montecastrilli",
           command="albopretorio_comune_montecastrilli").save()
    Source(id=3,
           name="Bollettino della Regione Umbria, serie generale",
           command="bollettino_regione_umbria_generale").save()
    Source(id=4,
           name="Bollettino della Regione Umbria, serie avvisi e concorsi",
           command="bollettino_regione_umbria_avvisi").save()
    Source(id=5, name="Bollettino della Regione Umbria, serie informazioni e comunicazione",
           command="bollettino_regione_umbria_informazioni").save()
