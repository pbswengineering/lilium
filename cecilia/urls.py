...
urlpatterns = [
    ...
    path("sensor_details/<str:sensor_name>/",
         views.sensor_details,
         name="sensor_details"),
    path("api/sensor_data/<str:sensor_name>/",
         views.sensor_data,
         name="api_sensor_data"),
    path("api/all_sensor_data/",
         views.all_sensor_data,
         name="api_all_sensor_data"),
    path("api/blueprint/<str:sensor_name>/",
         views.blueprint,
         name="api_blueprint"),
]
